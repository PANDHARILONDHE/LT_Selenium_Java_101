...
public class Scenarios_LT {
	...
	String access_key = "HDAFhuS69PtlaDZ3WI00OhDYM9P9gIEud75sNYenMSDAgU9Sro";
    ...
    public void setUp(String browser,String browserVersion,String platform ) throws Exception {
        ...
        capabilities.setCapability("build", "Selenium java 101"+platform +" : "+browser);
        capabilities.setCapability("name", "Selenium java 101 Run " +browser);
